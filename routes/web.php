...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/transactions/{transaction}/processing', [TransactionController::class, 'processing'])->name('payment.processing');
...
Route::middleware(['auth','instructor'])->prefix('instructor')->name('instructor.')->group(function () {
    ...
    Route::put('sections/{section}/lessons/{lesson}',            [InstructorCourseController::class, 'updateLesson'])->name('sections.lessons.update');
